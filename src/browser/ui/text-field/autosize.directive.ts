import { AfterViewInit, Directive, DoCheck, ElementRef, Input, NgZone, OnDestroy, Renderer2 } from '@angular/core';
...
export class AutosizeDirective implements AfterViewInit, DoCheck, OnDestroy {
    ...
    private resizeToFitContent(force: boolean = false): void {
        ...
        textarea.style.height = `${textarea.scrollHeight + 2}px`; // 2 is for border.
